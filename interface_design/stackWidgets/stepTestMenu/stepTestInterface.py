...
"}")
        ...
        self.SequenceEditorTable.setColumnCount(5)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.SequenceEditorTable.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
    ...
    def retranslateUi(self, Frame):
        ...
        item = self.SequenceEditorTable.horizontalHeaderItem(4)
        item.setText(_translate("Frame", "row number"))
